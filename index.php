						...
						<div class="btn-group">
							<div class="dropdown">
							  ...
							  <div class="dropdown-content">
								  <input type="button" value="&#129315;"name="&#129315;" onclick="getEmoji(this)" class="button" title="ROFL, developed by Mo"/>
								  <input type="button" value="&#128526;"name="&#128526;" onclick="getEmoji(this)" class="button" title="Sunglasses, developed by Mo"/>
								  <input type="button" value="&#128557;" name="&#128557" onclick="getEmoji(this)" class="button" title="Loudly crying"/>
								  <input type="button" value="&#128561;" name="&#128561" onclick="getEmoji(this)" class="button" title="Shocked"/>
								  <input type="button" value="&#128530;" name="&#128530;" onclick="getEmoji(this)" class="button" title="Unamused"/>
								  <input type="button" value="&#128527;" name="&#128527;" onclick="getEmoji(this)" class="button" title="Smirking"/>
								  <input type="button" value="&#128564;" name="&#128564;" onclick="getEmoji(this)" class="button" title="Sleeping, RIP Mo's sleep"/>
								  <input type="button" value="&#128548;" name="&#128548;" onclick="getEmoji(this)" class="button" title="Mad"/>
								  <input type="button" value="&#128544;" name="&#128544;" onclick="getEmoji(this)" class="button" title="Madder"/>
								  <input type="button" value="&#128545;" name="&#128545;" onclick="getEmoji(this)" class="button" title="MAD AS AHEN QUOTE"/>
								  <input type="button" value="&#129488;" name="&#129488;" onclick="getEmoji(this)" class="button" title="The YIP have arrived."/>
								  <input type="button" value="&#129318;" name="&#129318;" onclick="getEmoji(this)" class="button" title="BRUV, AHEN QUOTE."/>
								  <input type="button" value="&#128373;" name="&#128373;" onclick="getEmoji(this)" class="button" title="The YIP has arrived, again."/>
                                                                                       
								  <input type="button" value="&#128077;"name="&#128077;" onclick="getEmoji(this)" class="button" title="Thumbs up, developed by Mo"/>
								  <input type="button" value="&#128076;" name="&#128076;" onclick="getEmoji(this)" class="button" title="NOICE"/>
								  <input type="button" value="&#128075;" name="&#128075;" onclick="getEmoji(this)" class="button" title="Hello! Bye! I'm waving."/>
                                                                                            
								  <input type="button" value="&#128064;" name="&#128064;" onclick="getEmoji(this)" class="button" title="Eyes, the YIP is watching you.."/>
								  <input type="button" value="&#128175;" name="&#128175;" onclick="getEmoji(this)" class="button" title="One + ninety-nine = hundred"/>
								  <input type="button" value="&#128293;" name="&#128293;" onclick="getEmoji(this)" class="button" title="Fire Nation"/>
								  <input type="button" value="&#128169;" name="&#128169;" onclick="getEmoji(this)" class="button" title="Earth Nation (no offense, we love Earth)"/>
								  <input type="button" value="&#127754;" name="&#127754;" onclick="getEmoji(this)" class="button" title="Water Nation"/>
								  <input type="button" value="&#9992;" 	name="&#9992;" onclick="getEmoji(this)" class="button" title="Air Nation"/>
								  <input type="button" value="&#129504" name="&#129504" onclick="getEmoji(this)" class="button" title="BIG BRAIN"/>
								  <input type="button" value="👁️&#128068👁️" name="👁️&#128068👁️" onclick="getEmoji(this)" class="button" title="Helpless..."/>
								  </div>
							</div>
						</div>
