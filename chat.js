...
//reload		// reload chat
		...
		function sendString(){
			...
			var clean = DOMPurify.sanitize(dirty, {ALLOWED_TAGS: ['b','em','strong','mark','del','a','ins','code','sup','sub','progress','h1','h2','h3','h4'],FORBID_ATTR: ['style','id']}); //clean that yucky stuff
			...
			clean = clean.replace(":yee:","<img src='Assets/yee.jpg' style='height:40px;width:40px;'")
			//gifs
			clean = clean.replace(":dogedance:","<img src='Assets/gifs/dogedance.gif'")
			clean = clean.replace(":hyperthink:","<img src='Assets/gifs/hyperthink.gif'")
			clean = clean.replace(":readtwice:","<img src='Assets/gifs/nandato.gif'")
			clean = clean.replace(":nosense:","<img src='Assets/gifs/logic_fails_me.gif'")
