...
window.onload = function () {
  ...
  function findlinks() {
    console.log("test345");
    //OLD var regex = /(?:(?:https?|ftp):\/\/|\b(?:[a-z\d]+\.))(?:(?:[^\s()<>]+|\((?:[^\s()<>]+|(?:\([^\s()<>]+\)))?\))+(?:\((?:[^\s()<>]+|(?:\(?:[^\s()<>]+\)))?\)|[^\s`!()\[\]{};:'".,<>?Â«Â»â€œâ€â€˜â€™]))?/ig
    var hrefURL = "";
    ...
    $("#mainpg #log").html(function (_, html) {
      ...
      //return html.replace(/((?:(?:https?|ftp):\/\/|\b(?:[a-z\d]+\.))(?:(?:[^\s()<>]+|\((?:[^\s()<>]+|(?:\([^\s()<>]+\)))?\))+(?:\((?:[^\s()<>]+|(?:\(?:[^\s()<>]+\)))?\)|[^\s`!()\[\]{};:'".,<>?Â«Â»â€œâ€â€˜â€™])))?/ig, "<a href=\"$1\">test</a>");
      //return html.replace(/((?:(?:https?|ftp):\/\/|\b(?:[a-z\d]+\.))(?:(?:[^\s()<>]+|\((?:[^\s()<>]+|(?:\([^\s()<>]+\)))?\))+(?:\((?:[^\s()<>]+|(?:\(?:[^\s()<>]+\)))?\)|[^\s`!()\[\]{};:'".,<>?Â«Â»â€œâ€â€˜â€™])))?/ig, "test");
      return html.replace(
  ...
  function saveToDB(savestring, onSuccess) {
    ...
    var poststring =
      "action=save&savestring=" + savestring + "&apikey=" + apikey;
  ...
  function testApi() {
    ...
    var poststring =
      "action=save&savestring=" + "this is a test" + "&apikey=12";
